	...
	public class BuySell {
		...
		public void viewBuySell(int id) throws ClassNotFoundException, SQLException {
		...
		System.out.println(id);
		    String s1="SELECT * FROM inventory as i,product as p,logindetails as l WHERE i.pid=p.pid and l.id=i.agntid and l.id='"+id+"' and trtype='"+buy+"' order by tdate desc";
